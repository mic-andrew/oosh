...
export const Technology = () => {
    return (
        <>
            ...
            <section className="shadow shadow-slate-400 rounded-2xl xl:flex gap-4">
                <div className="xl:w-2/3 border-r px-4 py-8 xl:p-12 space-y-12">
                    <div className='space-y-8'>

                        <h2 className="text-2xl font-bold"><span className="text-slate-400">Explore / </span> Technology</h2>
                        <div className='space-y-4'>
                            ...
                            <div className="flex gap-3 items-center">
                                ...
                                <div>
                                    <p className='text-lg font-bold'>Drones Articles </p>
                                    <p className='text-xs'>1hr public</p>
                                </div>
                            </div>

                            <p className='text-justify'>How to Stabilize Your Drone Camera With a Gimbal. If you are hoping to use your drone for photography, you
                                may want to consider buying a gimbal. A gimbal is a support system that allows an object to remain
                                horizontal regardless of the motion around it. Gimbals were widely used in waterborne vessels.
                            </p>
                    ...
                    <div className='space-y-8'>
                        ...
                        <h2 className="text-2xl font-bold"><span className="text-slate-400">Explore / </span> Articles</h2>
                        <div className='space-y-4'>
                ...
                <div className="xl:w-1/3 py-5 space-y-4">
                    <h2 className='text-xl font-bold border-b py-3 px-5'>Recent Technology Events</h2>

                    <Link to="/dashboard/events">
                        <div className='border-b py-3 px-5 hover:bg-slate-100'>
                            <h2 className='text-xl font-bold'>LAGOS TECH FEST</h2>
                            <div className='flex gap-3 items-center pb-2'>
                                <p className='text-sm '>by Everythive.ng</p>
                                <p className='text-sm bg-orange-200 text-orange-600 font-semibold px-3 py-0.5 rounded'>Free</p>
                            </div>
                            <div className='space-y-1'>
                                <div className='flex gap-4'>
                                    <p className='text-sm'><i class="fa-regular fa-file-lines"></i></p>
                                    <p className='text-sm'>Technology</p>
                                </div>

                                <div className='flex gap-4'>
                                    <p className='text-sm'><i class="fa-solid fa-clock"></i></p>
                                    <p className='text-sm'>Wed, Dec 15, 2022, 9:00 AM</p>
                                </div>

                                <div className='flex gap-4'>
                                    <p className='text-sm'><i class="fa-solid fa-location-crosshairs"></i></p>
                                    <p className='text-sm w-4/6'>Landmark Centre Water Corporation Drive #Plot 2 & 3 Annex, LA 106104</p>
                                </div>

                            </div>

                            <div className='flex justify-between mt-4 items-center'>
                                <div className='font-semibold'>11.5k Followers</div>
                                <button className='border rounded-full px-3 py-2'><i class="fa-regular fa-heart"></i></button>
                            </div>
                        </div>
                    </Link>
                    ...
                    <Link to="/dashboard/events">
                        <div className='border-b py-3 px-5 hover:bg-slate-100'>
                            <h2 className='text-xl font-bold'>BGIT : Tap Into Tech Lagos</h2>
                            <div className='flex gap-3 items-center pb-2'>
                                <p className='text-sm '>by Black Girls in Tech</p>
                                <p className='text-sm bg-orange-200 text-orange-600 font-semibold px-3 py-0.5 rounded'>Paid</p>
                            </div>
                            <div className='space-y-1'>
                                <div className='flex gap-4'>
                                    <p className='text-sm'><i class="fa-regular fa-file-lines"></i></p>
                                ...
                                <div className='flex gap-4'>
                                    <p className='text-sm'><i class="fa-solid fa-clock"></i></p>
                                    <p className='text-sm'>Sat, Oct 29, 1:00 PM</p>
                                </div>

                                <div className='flex gap-4'>
                                    <p className='text-sm'><i class="fa-solid fa-location-crosshairs"></i></p>
                                    <p className='text-sm w-4/6'>Admiralty Way Admiralty Way Lagos, LA 106104</p>
                                </div>
                    ...
                    <Link to="/dashboard/events">
                        <div className='border-b py-3 hover:bg-slate-100 px-5'>
                            <h2 className='text-xl font-bold'>LAGOS TECH FEST</h2>
                            <div className='flex gap-3 items-center pb-2'>
                                <p className='text-sm '>by Everythive.ng</p>
                                <p className='text-sm bg-orange-200 text-orange-600 font-semibold px-3 py-0.5 rounded'>Free</p>
