...
export const ChatSection = () => {
  const myChat = [
    { body: "this is a good one", time: 10, sent: true },
    { body: "Thanks for the compliement", time: 10, sent: false },
    { body: "You are welcome", time: 11, sent: true },
    { body: "hi", time: 11, sent: false },
    { body: "Hope you have eaten", time: 12, sent: true },
    { body: "Thank you very much i have eaten", time: 12, sent: false },
    { body: "I will be comming to your house today", time: 12, sent: true },
    { body: "Ok, no problem i'll be expecting you", time: 12, sent: false },
  ];
  ...
  const [chatList, setChatList] = useState(myChat);

  const sendChat = () => {
    var newChat = myChat.push({ body: chatBody, time: 13, sent: true });
    var newChat = { body: chatBody, time: 13, sent: true };
  ...
  return (
    <>
      <div>
          ...
          <div className="flex gap-4 items-center justify-center">
            <div>
              <img
                src={img9}
                alt="image"
                className="rounded-full w-10 2xl:w-full"
              />
            </div>
            <div className="">
              ...
              <div className="flex gap-2 text-xs 2xl:text-base items-start font-medium">
                <p>Active now</p>
                <div>
                  <i class="fa-solid fa-circle text-green-500 text-[5px]"></i>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="my-3">
          <p className="text-xs 2xl:text-lg font-semibold text-center">
            March 06, 2022
          </p>
        </div>
      </div>

      {audioCall && <IncomingCall handleMakeCall={handleMakeCall} />}

      {videoCall && <VideoCall handleVideoCall={handleVideoCall} />}

      <div className="overflow-y-scroll h-[90%] space-y-6 w-full py-5">
        {chatList.map((each) => {
          if (each.sent === true) {
            return (
              <div
                ...
                <div>
                  ...
                  {chatOpt && (
                    <div className="absolute shadow bg-white shadow-slate-400 rounded-lg left-1 md:left-auto z-20 2xl:right-auto py-2 top-5 2xl:ml-2 md:px-4 2xl:px-4">
                      <div
                        className="px-5 py-2 text-xs 2xl:text-base"
                        onClick={() => showchatOpt("reply")}
                      >
                        <button>Reply</button>
                      </div>
                      <div className="px-5 py-2 text-xs 2xl:text-base">
                ...
                <div className="flex items-end space-x-4">
                  <div className="space-y-1.5">
                    <div className="bg-slate-100 text-black md:w-96 2xl:w-[500px]  rounded-tl-xl rounded-tr-xl rounded-br-xl p-5">
                      <p className="text-sm 2xl:text-base">{each.body} </p>
                    </div>
                  ...
                  <div className="flex items-end -space-x-3">
                    <img
                      src={img8}
                      alt="image"
                      className="rounded-full w-28 md:w-14 2xl:w-12"
                    />
                  </div>
                </div>
              </div>
            ...
            return (
              <div key={each.body} className="flex items-center relative">
                <div className="flex items-start space-x-4">
                  <div className="flex items-end -space-x-2 2xl:-space-x-3">
                    ...
                    />
                    <div>
                      <i class="fa-solid fa-circle text-green-500 text-[10px] 2xl:text-xs "></i>
                    </div>
                  </div>
                  <div className="space-y-1.5">
          ...
          {replyChat && (
            <div className="bg-gray-200 rounded-lg absolute z-10 -top-20 py-4 px-10">
              <div className="flex justify-between">
                ...
                <button onClick={showreplyChat}>
                  <i className=" text-sm fa-solid fa-xmark"></i>
                </button>
              </div>
              <p className="text-xs">
                Hello! How are you doing and the business
              </p>
            </div>
          )}
                ...
                <div className="flex justify-center flex-1 items-center">
                  <div className="relative w-full focus-within:text-orange-600 ">
                    ...
                    <input
                      ...
                      className="w-full my-4 py-3 pr-20 text-sm text-gray-700 placeholder-gray-600 bg-gray-100 border-0 rounded-md dark:focus:shadow-outline-gray  focus:placeholder-gray-500 focus:bg-white focus:border-orange-300 focus:outline-none focus:shadow-outline-purple "
                      type="text"
      ...
      <ChatProfile
        ...
        handleSideProfile={handleSideProfile}
      />
    </>
  );
};
