                    ...
                    <div className="lg:w-80 bg-gray-100 flex flex-wrap lg:block justify-between">
                        <div className="">
                            <button
                                ...
                                className="p-4 md:px-5 md:py-4 lg:px-6 lg:py-5 xl:p-6 text-sm font-medium md:w-28 text-center mx-auto lg:text-left text-gray-500 md:border-x md:border-y lg:border-r-2 border-transparent hover:text-gray-700 border-gray-300 dark:text-gray-400 dark:hover:text lg:-gray-300 lg:w-full active"
                                active={active === "tab1"}
                            >
