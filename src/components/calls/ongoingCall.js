        ...
        <>
            ...
            <div className="absolute top-0 left-0" >
                <div className="inset-0 fixed bg-slate-800 w-screen z-50 h-screen bg-opacity-60 flex items-center px-3">
                    ...
                    <div className="shadow shadow-slate-400 rounded-lg space-y-4 overflow-y-scroll h-[90%] xl:h-[80%] bg-white mx-auto w-full lg:w-2/3 2xl:w-2/3 ">
                        ...
                        <div className='2xl:px-8  py-4  px-4 md:px-6 space-y-4 relative'>
                            <div className='xl:flex gap-8 justify-between xl:fixed xl:w-[62%]'>
                                ...
                                <div className='w-full xl:w-2/3 '>
                                    ...
                                    <div className='space-y-4 mt-14 '>
                                        <div>
                                            <img src={dp} alt="image" className='w-24 xl:w-auto rounded-full mx-auto' />
                                        </div>
                                    ...
                                    <div className='flex gap-6 justify-center xl:mt-36 mt-24 mb-12 xl:mb-6'>
